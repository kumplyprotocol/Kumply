  ...
  return (
    <div className="container branding-container">
      ...
      <div className="branding-grid">
        ...
        <BrandAssetCard src={`${ASSET_BASE}/png/lockup-light-transparent-2000.png`} title={t("cardLockupPngTransparentLightTitle")} subtitle={t("cardLockupPngTransparentLightSubtitle")} downloadHref={`${ASSET_BASE}/png/lockup-light-transparent-2000.png`} downloadLabel={t("downloadPng")} preview="checker" thumbStyle={{ width: "100%" }} />
        <BrandAssetCard src={`${ASSET_BASE}/png/lockup-dark-transparent-2000.png`} title={t("cardLockupPngTransparentDarkTitle")} subtitle={t("cardLockupPngTransparentDarkSubtitle")} downloadHref={`${ASSET_BASE}/png/lockup-dark-transparent-2000.png`} downloadLabel={t("downloadPng")} preview="checker" thumbStyle={{ width: "100%" }} />
